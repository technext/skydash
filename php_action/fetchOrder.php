...
$sql = "SELECT order_id, order_date, client_name, client_contact, client_ic, payment_status FROM orders WHERE order_status = 1";
...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	if($row[5] == 1) { 		
 		...
 		$paymentStatus = "<label class='badge badge-warning'>Advance Payment</label>";
 	} else { 		
 		$paymentStatus = "<label class='badge badge-danger'>No Payment</label>";
 	} // /else
